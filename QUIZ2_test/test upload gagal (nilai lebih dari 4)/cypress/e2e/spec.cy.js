describe('empty spec', () => {
  it('passes', () => {
    ...
    cy.get(':nth-child(8) > .input-group > .form-control').type("5")
    cy.get(':nth-child(14) > .input-group > .form-control').type("5")
    cy.get(':nth-child(20) > .input-group > .form-control').type("5")
